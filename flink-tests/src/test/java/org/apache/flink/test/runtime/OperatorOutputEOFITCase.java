...
public class OperatorOutputEOFITCase extends TestLogger {
    ...
    @Test
    public void coGroupWithEndOfStreamTriggerTest() throws Exception {
        /*
    ...
    @Test
    public void coGroupWithEndOfStreamTriggerBlockingTest() throws Exception {
        /*
         * Test that CoGroup using EndOfStreamTrigger outputs right result;
         */
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
